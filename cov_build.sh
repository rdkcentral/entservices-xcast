...
############################
# Build entservices-xcast
echo "building entservices-xcast"

cd ${GITHUB_WORKSPACE}
cmake -G Ninja -S "$GITHUB_WORKSPACE" -B build/entservices-xcast \
-DUSE_THUNDER_R4=ON \
-DCMAKE_INSTALL_PREFIX="$GITHUB_WORKSPACE/install/usr" \
-DCMAKE_SYSROOT="$GITHUB_WORKSPACE/install" \
...
cmake --build build/entservices-xcast --target install
echo "======================================================================================"
exit 0
